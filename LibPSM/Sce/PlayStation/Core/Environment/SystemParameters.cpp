...
namespace Sce::PlayStation::Core::Environment {
	int SystemParameters::GetInt(Sce::PlayStation::Core::Environment::SystemParameters/ParameterKey, int *){
	...
	int SystemParameters::GetFloat(Sce::PlayStation::Core::Environment::SystemParameters/ParameterKey, float *){
	...
	int SystemParameters::GetString(Sce::PlayStation::Core::Environment::SystemParameters/ParameterKey, string *){
